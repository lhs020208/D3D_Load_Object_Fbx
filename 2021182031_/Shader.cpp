...
{
	// slot0: POSITION(0) NORMAL(12) TEXCOORD(24)
	// slot1: BLENDINDICES (0)
	// slot2: BLENDWEIGHT  (0)
	...
	d[3] = { "BLENDINDICES", 0, DXGI_FORMAT_R32G32B32A32_UINT,  1,  0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
	d[4] = { "BLENDWEIGHT",  0, DXGI_FORMAT_R32G32B32A32_FLOAT, 2,  0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
